 ...
 */
export function allDifferentConstraint(
  variables: string[],
  name = "alldiff",
): CSPConstraint {
  return {
 ...
 */
export function notEqualConstraint(
  var1: string,
  var2: string,
  name = "neq",
): CSPConstraint {
 ...
 */
export function equalConstraint(
  var1: string,
  var2: string,
  name = "eq",
): CSPConstraint {
 ...
 */
export function valueConstraint(
  varId: string,
  value: any,
  name = "val",
): CSPConstraint {
 ...
 */
export function notValueConstraint(
  varId: string,
  value: any,
  name = "notval",
): CSPConstraint {
 ...
 */
export function arithmeticConstraint(
  var1: string,
  offset: number,
  var2: string,
  name = "arith",
