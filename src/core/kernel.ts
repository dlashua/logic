...
export function createEnrichedSubst(
  ...
  newSubst.set(GOAL_GROUP_CONJ_GOALS, [...(new Set([...conjGoals, ...conjInnerConj]))]);
  newSubst.set(GOAL_GROUP_ALL_GOALS, [...(new Set([...parentOuterGoals, ...conjGoals, ...disjGoals, ...disjInnerAll]))]);
  return newSubst;
}
