...
import { lvar, enrichGroupInput } from "../../core/kernel.ts"
...
console.dir(
  await query()
    ...
    .where($ => [
      constrainArrays($, 5),
      link($, {
        a: "A", n: 1, d: "AA", i: 11, f: "AAA" 
      }),
      link($, {
        a: "B", n: 2, d: "BB", i: 22, f: "BBB" 
      }),
      link($, {
        a: "C", n: 3, d: "CC", i: 33, f: "CCC" 
      }),
      link($, {
        a: "D", n: 4, d: "DD", i: 44, f: "DDD" 
      }),
      link($, {
        a: "E", n: 5, d: "EE", i: 55, f: "EEE" 
      }),
