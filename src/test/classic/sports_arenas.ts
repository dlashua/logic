...
const sports = ["baseball", "basketball", "football", "hockey", "lacrosse", "rugby", "soccer"];
// const names = ["beck", "dotson", "frederick", "ingram", "rowe", "underwood", "wilcox"];
const names = ["beck", "dotson", "frederick", "ingram", "rowe", "underwood", "wilcox"];

const towns = ["brunswick", "leeds", "new_c", "ocotillo", "paramount", "schaller", "zwingle"];
...
const results = query()
  ...
  .where($ => [
    ...
    or(
      and( // beck = 150, basketball = schaller
      ...
      and( // beck = schaller, basketball = 150
